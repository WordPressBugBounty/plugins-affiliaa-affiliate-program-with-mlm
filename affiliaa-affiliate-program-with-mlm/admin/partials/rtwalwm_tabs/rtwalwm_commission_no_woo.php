...
<table class="rtwalwm-table form-table">
	<tbody>
		...
		<tr>
			<th>
				<?php esc_html_e( 'Maximum commission to an Affiliate in a month', 'affiliaa-affiliate-program-with-mlm' ); ?>
			</th>
			<td class="tr2">
		...
		<tr>
			<th>
				<?php esc_html_e( 'Withdrawal Fees', 'affiliaa-affiliate-program-with-mlm' ); ?>
			</th>
			<td class="tr2">
		...
		<tr>
			<th>
				<?php esc_html_e( 'Unlimited / Lifetime Commission', 'affiliaa-affiliate-program-with-mlm' ); ?>
			</th>
			<td class="tr2">
				
				<p>
					<span class="rtwalwm-custom-radio">
						<input id="radio-10" type="radio" class="rtwalwm_override_show_hide" name="" value="1"  /><?php esc_html_e( 'Yes', 'affiliaa-affiliate-program-with-mlm' ); ?>
						<label for="radio-10"></label>
					</span>
				</p>
				<p>
					<span class="rtwalwm-custom-radio">
					  	<input id="radio-11" type="radio" class="rtwalwm_override_show_hide" name="" value=""  /><?php esc_html_e( 'No', 'affiliaa-affiliate-program-with-mlm' ); ?>
		...
		<tr class="rtwalwm_override rtwalwm_override_hide">
			<th>
				<?php esc_html_e( 'Override Referrer in Unlimited Commission', 'affiliaa-affiliate-program-with-mlm' ); ?>
			</th>
			<td class="tr2">
			
				<p>
					<span class="rtwalwm-custom-radio">
						<input id="radio-12" type="radio" class="" name="" value=""  /><?php esc_html_e( 'Yes', 'affiliaa-affiliate-program-with-mlm' ); ?>
						<label for="radio-12"></label>
					</span>
				</p>
				<p>
					<span class="rtwalwm-custom-radio">
					  	<input id="radio-13" type="radio" class="" name="rtwwwap_commission_settings_opt[override_unlimit_comm]" value=""  /><?php esc_html_e( 'No', 'affiliaa-affiliate-program-with-mlm' ); ?>
